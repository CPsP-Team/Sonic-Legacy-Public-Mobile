...
class DesktopMiscSettings extends DesktopBaseOptions
{
	public function new()
	{
		...
		var option:DesktopOption = new DesktopOption('GPU Caching', 'If enabled, allows assets to be cached directly to the GPU. helps Performance',
			'cacheOnGPU', 'bool', false);
		addOption(option);
		/*
