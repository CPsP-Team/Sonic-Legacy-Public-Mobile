...
class CharacterEditorState extends MusicBeatState
{
	...
	function addCharacterUI() {
		...
		pauseAnimDuringSustains = new FlxUICheckBox(singDurationStepper.x + 80, singDurationStepper.y + 20, null, null, "pause Sustains?", 50);
		pauseAnimDuringSustains.checked = char.pauseAnimForSustain;
		pauseAnimDuringSustains.callback = function () {
			char.pauseAnimForSustain = pauseAnimDuringSustains.checked;
		}
		...
		tab_group.add(pauseAnimDuringSustains);
	...
	var pauseAnimDuringSustains:FlxUICheckBox;
	...
	function saveCharacter() {
		var json = {
			...
			"pauseDuringSustains": char.pauseAnimForSustain
		};
