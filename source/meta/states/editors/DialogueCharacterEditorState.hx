...
import gameObjects.DialogueBoxPsych.DialogueCharacter;
import gameObjects.DialogueBoxPsych.DialogueCharacterFile;
import gameObjects.DialogueBoxPsych.DialogueLine;
import gameObjects.DialogueBoxPsych.DialogueAnimArray;
	...
	override function update(elapsed:Float) {
		...
		if(!blockInput && !animationDropDown.dropPanel.visible) {
			...
			if(FlxG.keys.justPressed.ESCAPE) {
				...
				FlxG.sound.playMusic(ProgressionHandler.getMenuMusic(), 1);
				transitioning = true;
			}
